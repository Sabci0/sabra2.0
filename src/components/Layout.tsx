      ...
      <div className="bg-neutral-900 text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center gap-6">
            ...
            <a
              href="mailto:kontakt@sabra.pl"
              className="flex items-center gap-2 hover:text-[#B5A642] transition-colors"
            >
              <Mail className="w-4 h-4" />
              <span className="hidden sm:inline">kontakt@sabra.pl</span>
            </a>
          </div>
          <div className="flex items-center gap-4">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="hover:text-[#B5A642]">
              <Facebook className="w-5 h-5" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-[#B5A642]">
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`block py-2 text-sm font-medium uppercase tracking-wider transition-colors ${
                    isActive(item.page) ? "text-[#B5A642]" : "text-neutral-700 hover:text-[#B5A642]"
                  }`}
                >
                  {item.name}
                </Link>
      ...
      <footer className="bg-neutral-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-400 text-sm">
                ...
                <li>00-000 Miejscowość</li>
                <li className="pt-2">
                  <a href="tel:+48123456789" className="hover:text-[#B5A642]">Tel: +48 123 456 789</a>
                </li>
                <li>
                  <a href="mailto:kontakt@sabra.pl" className="hover:text-[#B5A642]">kontakt@sabra.pl</a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-neutral-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-[#B5A642]">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-[#B5A642]">
                <Instagram className="w-5 h-5" />
              </a>
            </div>
          </div>
